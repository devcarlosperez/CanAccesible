    ...
    await queryInterface.bulkInsert('Incidents', [
      {
        ...
        nameFile: 'https://images-cruds.fra1.digitaloceanspaces.com/incident-image/91K8fRwTrSL._AC_SL1500_%20(1).jpg',
        isApproved: true,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        nameFile: 'https://images-cruds.fra1.digitaloceanspaces.com/incident-image/IMG_2992-2%20(1).jpg',
        isApproved: true,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        nameFile: 'https://images-cruds.fra1.digitaloceanspaces.com/incident-image/EOSR2046%20(1).jpg',
        isApproved: true,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
