    ...
    await queryInterface.bulkInsert('Incidents', [
      {
        ...
        incidentTypeId: 2,
        userId: 1,
        title: 'Rampa insuficiente en edificio público',
        area: 'movilidad',
        ...
        nameFile: 'https://images-cruds.fra1.digitaloceanspaces.com/incident-image/91K8fRwTrSL._AC_SL1500_.jpg',
        isApproved: true,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        incidentTypeId: 2,
        userId: 2,
        title: 'Parada de autobús sin espacio accesible',
        area: 'movilidad',
        ...
        nameFile: 'https://images-cruds.fra1.digitaloceanspaces.com/incident-image/IMG_2992-2.jpg',
        isApproved: true,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        incidentTypeId: 2,
        userId: 1,
        title: 'Ascensor sin audio para personas con discapacidad visual',
        area: 'sensorial',
        ...
        nameFile: 'https://images-cruds.fra1.digitaloceanspaces.com/incident-image/EOSR2046.jpg',
        isApproved: true,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
