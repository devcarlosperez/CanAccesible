  ...
  async up (queryInterface, Sequelize) {
    await queryInterface.bulkInsert('BlogArticles', [
      ...
      },
      {
        ...
        nameFile: 'https://images-cruds.fra1.digitaloceanspaces.com/blog-image/mapa-dinamico.png',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
      ...
      },
      {
        ...
        nameFile: 'https://images-cruds.fra1.digitaloceanspaces.com/blog-image/Responsive.webp',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
    ], {});
