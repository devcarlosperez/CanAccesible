  ...
  async up (queryInterface, Sequelize) {
    await queryInterface.bulkInsert('BlogArticles', [
      ...
      },
      {
        ...
        nameFile: 'https://images-cruds.fra1.digitaloceanspaces.com/blog-image/Rueda_WCAG.jpg.jpg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        nameFile: 'https://images-cruds.fra1.digitaloceanspaces.com/blog-image/Canary-Islands-Road-Map.jpg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        nameFile: 'https://images-cruds.fra1.digitaloceanspaces.com/blog-image/vista-trasera-joven-discapacidad-sentado-silla-ruedas-usando-rampa-subir-scaled-1.jpg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        nameFile: 'https://images-cruds.fra1.digitaloceanspaces.com/blog-image/responsive.jpg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
    ], {});
