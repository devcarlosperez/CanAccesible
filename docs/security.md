...
- **Configuration**:
  - **Allowed Origins**:
    - `https://canaccesible.es`, `https://www.canaccesible.es`: Production domains.
    - `http://localhost:5173`, `http://localhost:85`: **Local Development and Testing Origins**. These are strictly allowed to facilitate the development cycle, permitting developers to run the frontend application locally while communicating with the API. This ensures functional testing and debugging in a controlled local environment.
